...
namespace AFPC {
    ...
    public class Overview {
        ...
        /// <summary>
        /// Разрешить контроллеру считывать просматриваемые входные значения и вращать камеру.
        /// По умолчанию для обычных игр FPS.
        /// </summary>
        ...
        /// <summary>
        /// Запретить контроллеру читать просматриваемые входные значения и вращать камеру.
        /// Используйте это, если хотите заблокировать возможность пользователя осмотреться.
        /// </summary>
        ...
        /// <summary>
        /// Разрешить пользователю изменять FOV камеры для просмотра удаленных объектов.
        /// </summary>
